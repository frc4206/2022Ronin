    ...
    addCommands(
        ...
        //align to shoot again
         ...
         //drive back to the hub 
          ...
          //aim at the hub
          new ParallelCommandGroup(
             new VisionAlignStopCommand(s_Swerve, true, true).withTimeout(0.4),
             new ConveyorAutoCommand(m_conveyor).withTimeout(0.4),
             new ShooterWallHubPlusCommand(m_shooter).withTimeout(0.4)
          ),
          ...
          new ParallelCommandGroup(
              ...
              new ConveyorForwardCommand(m_conveyor).withTimeout(2),
