...
public class Kevins3to5BallShortEndAuto extends SequentialCommandGroup {
  public Kevins3to5BallShortEndAuto(SwerveSubsystem s_Swerve, HarvestorSubsystem m_harvestor, ConveyorSubsystem m_conveyor, ShooterSubsystem m_shooter, PneumaticsSubsystem m_pneumatics){
    ...
    Trajectory tarjectoryPart2 =
        ...
        new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(100), new Rotation2d(Units.degreesToRadians(90))),
        config);

    Trajectory tarjectoryPart3 =
        TrajectoryGenerator.generateTrajectory(
            //Turn and move back to face the hub so you can shoot the cargo
            new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(100), new Rotation2d(Units.degreesToRadians(120))),
    ...
    Trajectory tarjectoryPart4 =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(Units.inchesToMeters(-30), Units.inchesToMeters(240), new Rotation2d(Units.degreesToRadians(110))),
            config);
            ...
            TrajectoryGenerator.generateTrajectory(
                ...
                List.of(
                  ...
                  new Translation2d(Units.inchesToMeters(0), Units.inchesToMeters(90))), 


                // End 3 meters straight ahead of where we started, facing forward
                new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(70), new Rotation2d(Units.degreesToRadians(-45))),
                config);
